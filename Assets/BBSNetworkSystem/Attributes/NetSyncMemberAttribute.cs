...
public sealed class FieldSyncAttribute : NetSyncBaseAttribute {
  /// <summary>
  /// This attribute signs that the field will be synchronized through the network. 
  /// The containing class also requires the <see cref="SyncAttribute"/>
  /// </summary>
  ...
  public FieldSyncAttribute(float lerpDamp = 1, /*bool reliable = false,*/ int accuracy = 2, float jumpThreshold = 0, bool initOnly = false) 
